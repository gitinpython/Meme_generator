...
A 'DocxIngestor' class will parse the Docx file & extract
message body & author, using them to return a collection of
...
class DocxIngestor(IngestorInterface):
    """Loads & parses data from Docx files.
    ...
    def parse(cls, path: str) -> List[QuoteModel]:
        """Parse the data from Docx file & return \
