...
# ELABORATE: Import your Ingestor and MemeEngine classes
...
def setup():
    ...
    # ELABORATE: Use the pythons standard library os class to find all
...
def meme_post():
    ...
    Extract image from html through user inputs & save in
